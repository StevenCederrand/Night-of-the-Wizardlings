...
#pragma region Sky_Debris
	m_objects.push_back(new MapObject("SkyboxSwirl"));
	m_objects[m_objects.size() - 1]->loadMesh("SkyBoxSwirl.mesh");
	m_objects[m_objects.size() - 1]->setTransform(glm::vec3(0.0f, 400.0f, 0.0f), glm::quat(glm::vec3(0.f, 0.f, 0.f)), glm::vec3(6.f, 6.f, 6.f));
