...
bool    ImGui_ImplGlfwGL3_Init(GLFWwindow* window, bool install_callbacks, const char* glsl_version)
{
    ...
    io.KeyMap[ImGuiKey_Tab]         = Input::isKeyPressed(GLFW_KEY_TAB);
    io.KeyMap[ImGuiKey_LeftArrow]   = Input::isKeyPressed(GLFW_KEY_LEFT);
    io.KeyMap[ImGuiKey_RightArrow]  = Input::isKeyPressed(GLFW_KEY_RIGHT);
    io.KeyMap[ImGuiKey_UpArrow]     = Input::isKeyPressed(GLFW_KEY_UP);
    io.KeyMap[ImGuiKey_DownArrow]   = Input::isKeyPressed(GLFW_KEY_DOWN);
    io.KeyMap[ImGuiKey_PageUp]      = Input::isKeyPressed(GLFW_KEY_PAGE_UP);
    io.KeyMap[ImGuiKey_PageDown]    = Input::isKeyPressed(GLFW_KEY_PAGE_DOWN);
    io.KeyMap[ImGuiKey_Home]        = Input::isKeyPressed(GLFW_KEY_HOME);
    io.KeyMap[ImGuiKey_End]         = Input::isKeyPressed(GLFW_KEY_END);
    io.KeyMap[ImGuiKey_Insert]      = Input::isKeyPressed(GLFW_KEY_INSERT);
    io.KeyMap[ImGuiKey_Delete]      = Input::isKeyPressed(GLFW_KEY_DELETE);
    io.KeyMap[ImGuiKey_Backspace]   = Input::isKeyPressed(GLFW_KEY_BACKSPACE);
    io.KeyMap[ImGuiKey_Space]       = Input::isKeyPressed(GLFW_KEY_SPACE);
    io.KeyMap[ImGuiKey_Enter]       = Input::isKeyPressed(GLFW_KEY_ENTER);
    io.KeyMap[ImGuiKey_Escape]      = Input::isKeyPressed(GLFW_KEY_ESCAPE);
    io.KeyMap[ImGuiKey_A]           = Input::isKeyPressed(GLFW_KEY_A);
    io.KeyMap[ImGuiKey_C]           = Input::isKeyPressed(GLFW_KEY_C);
    io.KeyMap[ImGuiKey_V]           = Input::isKeyPressed(GLFW_KEY_V);
    io.KeyMap[ImGuiKey_X]           = Input::isKeyPressed(GLFW_KEY_X);
    io.KeyMap[ImGuiKey_Y]           = Input::isKeyPressed(GLFW_KEY_Y);
    io.KeyMap[ImGuiKey_Z]           = Input::isKeyPressed(GLFW_KEY_Z);
